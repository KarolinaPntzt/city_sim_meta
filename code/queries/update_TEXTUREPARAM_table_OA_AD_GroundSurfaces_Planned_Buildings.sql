...
--that correspond to GroundSurfaces
...
/*
-- Step 2.a --
--Add GroundSurface geometries for existing buildings in TEXTUREPARAM
...
ON CITYOBJECT.ID = SURFACE_GEOMETRY.CITYOBJECT_ID 
WHERE CITYOBJECT.OBJECTCLASS_ID = 35
AND CITYOBJECT.GMLID NOT LIKE 'pb-gs%';
...
/*
-- Step 2.b --
--Add GroundSurface geometries of planned buildings in TEXTUREPARAM
CREATE TEMPORARY TABLE textureparam_temp
(surface_geometry_id BIGINT,
is_texture_parametrization INT,
world_to_texture VARCHAR(1000),
...
ON CITYOBJECT.ID = SURFACE_GEOMETRY.CITYOBJECT_ID 
WHERE CITYOBJECT.OBJECTCLASS_ID = 35
AND CITYOBJECT.GMLID LIKE 'pb-gs%';
...
/*
-- Step 3.a --
--Set the color for GroundSurface of existing buildings:
...
-- Step 3.b --
--Set the color of the GroundSurface of planned buildings:
UPDATE citydb.TEXTUREPARAM
...
WHERE SURFACE_GEOMETRY_ID IN (
	...
	INNER JOIN TEXTUREPARAM 
	ON SURFACE_GEOMETRY.ID = TEXTUREPARAM.SURFACE_GEOMETRY_ID
	WHERE CITYOBJECT.GMLID LIKE 'pb-gs%');
